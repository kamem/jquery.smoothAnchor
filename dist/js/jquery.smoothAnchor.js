/*!
 * jquery.smoothAnchor (2016-7-29)
 * Performs a smooth page scroll to an anchor on the same page.
 * https://github.com/kamem/jquery.smoothAnchor.git
 * (c) 2016 kamem (@kamem)
 *
 * @version 0.2.0
...
;(function() {
var smoothAnchor_Scroll = {}, jquerysmoothAnchorjs;
smoothAnchor_Scroll = function (exports) {
...
jquerysmoothAnchorjs = function (_Scroll) {
  $.smoothAnchorByLoaded = function () {
  ...
  $.smoothAnchorStart = function () {
    var options = arguments.length <= 0 || arguments[0] === undefined ? {} : arguments[0];
    var scroll = new _Scroll.Scroll(options);
    scroll.scrollStart(options.target, options.complate);
  };
  $.fn.smoothAnchor = function () {
    var options = arguments.length <= 0 || arguments[0] === undefined ? {} : arguments[0];
    var scroll = new _Scroll.Scroll(options);
